    ...
    try {
        ...
        if (isLearningRequest) {
            ...
            const languagePatterns = {
                ...
                'meteor': ['meteor', 'meteorjs', 'meteor.js'],
                ...
                'strapi': ['strapi', 'strapijs', 'strapi.js'],
                'drupal': ['drupal', 'drupal cms'],
                'wordpress': ['wordpress', 'wp'],
                'joomla': ['joomla', 'joomla cms'],
                'magento': ['magento', 'magento ecommerce'],
            ...
            // If no specific language is detected, default to Python for frameworks
